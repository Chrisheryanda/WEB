                ...
                <table class="table table-striped table-bordered display nowrap" id="dataTableAdmin">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td scope="row">{{ $ssw->wali_kelas->kode_wali_kelas }}</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        <label for="wali_kelas" class="col-form-label font-weight-bold">Kode Wali Kelas:</label>
                        <input type="text" class="form-control" id="kode_wali_kelas" name="kode_wali_kelas" value="{{ $ssw->wali_kelas->kode_wali_kelas }}" disabled>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('data.siswa.store') }}">
                    ...
                    <div class="mb-3">
                        <label for="id_wali_kelas" class="col-form-label font-weight-bold">Kode Wali Kelas:</label>
                        <select class="form-control" name="id_wali_kelas" id="id_wali_kelas" required>
                            <option selected disabled>--- Pilih ---</option>
                            @foreach ($wali_kelas as $wks)
                            <option value="{{ $wks->id }}">{{ $wks->kode_wali_kelas }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="id_jurusan" class="col-form-label font-weight-bold font-weight-bold">Jurusan:</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('data.siswa.update', $ssw->id) }}">
                    ...
                    <div class="mb-3">
                        <label for="id_wali_kelas" class="col-form-label font-weight-bold">Wali Kelas:</label>
                        <select class="form-control" name="id_wali_kelas" id="id_wali_kelas" required>
                            <option disabled>--- Pilih ---</option>
                            <option value="{{ $ssw->wali_kelas->id }}" selected hidden>{{ $ssw->wali_kelas->kode_wali_kelas }}</option>
                            @foreach ($wali_kelas as $wks)
                            <option value="{{ $wks->id }}">{{ $wks->kode_wali_kelas }}</option>
                            @endforeach
                        </select>
